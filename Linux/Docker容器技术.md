![image-20220629215534772](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/0.png)
...
![image-20220630161240162](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/1.png)

![image-20220630161341541](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/2.png)
...
![image-20220630165259663](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/3.png)

首选它会从镜像仓库中下载对应的镜像，国内访问速度还行，不需要单独配置镜像源。接着下载完成后，就会在后台运行了，我们可以使用浏览器访问试试看：

![image-20220630165430159](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/4.png)

![image-20220630165440751](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/5.png)
...
![image-20220630171220207](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/6.png)

我们家用级CPU一般是AMD的锐龙系列和Intel的酷睿系列（比如i3 i5 i7 i9），而服务器CPU一般是Intel的志强（Xeno）系列，这种CPU的特点就是核心数非常多：

![image-20220630172135408](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/7.png)
...
![image-20220630173915254](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/8.png)

我们可以使用VMware来创建虚拟机，这些虚拟机实际上都是基于我们当前系统上的VMware软件来运行的，当然VMware也有服务器专用的虚拟化软件，有了虚拟化之后，我们的服务器就像这样：

![image-20220630174945749](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/9.png)
...
![image-20220630181037698](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/10.png)
...
![image-20220630182136717](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/11.png)
...
![image-20220630184857540](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/12.png)
...
![image-20220701111043417](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/13.png)
...
![image-20220701111314331](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/14.png)
...
![image-20220701111840091](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/15.png)
...
![image-20220701125951980](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/16.png)
...
![image-20220701124845982](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/17.png)
...
![image-20220701125025173](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/18.png)
...
![image-20220701125108834](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/19.png)

删除后，容器将不复存在，当没有任何关于nginx的容器之后，我们可以删除nginx的本地镜像：

![image-20220701125204728](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/20.png)
...
![image-20220701125514145](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/21.png)
...
![image-20220701132622893](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/22.png)

可以看到，CentOS的base镜像就已经下载完成，不像我们使用完整系统一样，base镜像的CentOS省去了内核，所以大小只有272M，这里需要解释一下base镜像的机制：

![image-20220701133111829](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/23.png)
...
![image-20220701135056123](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/24.png)
...
![image-20220701135834325](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/25.png)

可以看到使用ls命令能够查看所有根目录下的文件，不过很多命令都没有，连clear都没有，我们来看看内核版本：

![image-20220701140018095](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/26.png)

可以看到内核版本是一样的（这也是缺点所在，如果软件对内核版本有要求的话，那么此时使用Docker就直接寄了），我们输入`exit`就可以退出容器终端了，可以看到退出后容器也停止了：

![image-20220701140225415](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/27.png)

当然我们也可以再次启动，注意启动的时候要加上`-i`才能进入到容器进行交互，否则会在后台运行：

![image-20220701140706977](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/28.png)

基于base镜像，我们就可以在这基础上安装各种各样的软件的了，几乎所有的镜像都是通过在base镜像的基础上安装和配置需要的软件构建出来的：

![image-20220701143105247](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/29.png)
...
![image-20220701151405640](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/30.png)

接着启动：

![image-20220701151433520](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/31.png)

直接使用apt命令来安装Java环境，在这之前先更新一下，因为是最小安装所以本地没有任何软件包：

![image-20220701151600847](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/32.png)
...
![image-20220701152018041](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/33.png)

这样，我们就完成了对Java环境的安装了，接着我们就可以退出这个镜像然后将其构建为新的镜像：

![image-20220701152130041](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/34.png)
...
![image-20220701152302171](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/35.png)

![image-20220701152418060](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/36.png)
...
![image-20220701155443170](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/37.png)
...
![image-20220701155812315](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/38.png)

最后成功安装，会出现在本地：

![image-20220701155847721](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/39.png)

可以看到安装出来的大小跟我们之前的是一样的，因为做的事情是一模一样的。我们可以使用`history`命令来查看构建历史：

![image-20220701160128689](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/40.png)

可以看到最上面两层是我们通过使用apt命令生成的内容，就直接作为当前镜像中的两层镜像，每层镜像都有一个自己的ID，不同的镜像大小也不一样。而我们手动通过`commit`命令来生成的镜像没有这个记录：

![image-20220701160406891](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/41.png)

如果遇到镜像ID为missing的一般是从Docker Hub中下载的镜像会有这个问题，但是问题不大。用我们自己构建的镜像来创建容器就可以直接体验带Java环境的容器了：

![image-20220701161546279](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/42.png)
...
![image-20220701164609666](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/43.png)

点击右上角的创建仓库，然后填写信息：

![image-20220701164939268](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/44.png)
...
![image-20220701165231001](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/45.png)

修改完成后，会创建一个新的本地镜像，名称就是我们自己定义的了。接着我们需在本地登录一下：

![image-20220701165446859](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/46.png)
...
![image-20220701165744647](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/47.png)

哈哈，500M的东西传上去，还是有点压力的，如果实在太慢各位可以重新做一个简单点的镜像。上传完成后，打开仓库，可以看到已经有一个1.0版本了：

![image-20220701165920060](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/48.png)

![image-20220701170053250](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/49.png)
...
![image-20220701170253126](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/50.png)
...
![image-20220701171148334](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/51.png)

上传之后的镜像是被压缩过的，所以下载的内容就比较少一些。运行试试看：

![image-20220701171253440](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/52.png)
...
![image-20220701173902376](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/53.png)
...
![image-20220701203741495](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/54.png)

![image-20220701202537650](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/55.png)
...
![image-20220701202846707](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/56.png)
...
![image-20220701203318098](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/57.png)
...
![image-20220701203518930](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/58.png)

最后成功构建：

![image-20220701204815069](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/59.png)

可以看到，Docker服务器上已经有了我们刚刚构建好的镜像：

![image-20220701204900943](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/60.png)

不过名称没有指定，这里我们重新配置一下：

![image-20220701204955570](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/61.png)

![image-20220701205053642](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/62.png)

重新进行构建，就是我们自定义的名称了：

![image-20220701205402607](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/63.png)

![image-20220701205350004](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/64.png)

我们来创建一个容器试试看：

![image-20220701205500494](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/65.png)

好了，现在基本环境搭建好了，我们接着就需要将我们的SpringBoot项目打包然后再容器启动时运行了，打开Maven执行打包命令：

![image-20220701205630885](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/66.png)
...
![image-20220701210438145](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/67.png)

可以看到历史中已经出现新的步骤了：

![image-20220701213513862](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/68.png)

接着启动我们的镜像，我们可以直接在IDEA中进行操作，不用再去敲命令了，有点累：

![image-20220701210845768](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/69.png)

![image-20220701210908997](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/70.png)

启动后可以在右侧看到容器启动的日志信息：

![image-20220701210946261](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/71.png)

![image-20220701211029119](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/72.png)
...
![image-20220701211536598](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/73.png)

配置好后，点击重新创建容器：

![image-20220701211701640](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/74.png)

重新运行后，我们就可以成功访问到容器中运行的SpringBoot项目了：

![image-20220701211753962](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/75.png)

当然，为了以后方便使用，我们可以直接将其推送到Docker Hub中，这里我们还是创建一个新的公开仓库：

![image-20220701212330425](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/76.png)

这次我们就使用IDEA来演示直接进行镜像的上传，直接点击：

![image-20220701212458851](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/77.png)

接着我们需要配置一下我们的Docker Hub相关信息：

![image-20220701212637581](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/78.png)

![image-20220701212731276](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/79.png)

OK，远程镜像仓库配置完成，直接推送即可，等待推送完成。

![image-20220701212902977](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/80.png)

可以看到远程仓库中已经出现了我们的镜像，然后IDEA中也可以同步看到：

![image-20220701213026214](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/81.png)
...
![image-20220702161742741](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/82.png)
...
![image-20220702170441267](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/83.png)
...
* **none网络：**这个网络除了有一个本地环回网络之外，就没有其他的网络了，我们可以在创建容器时指定这个网络。
  ...
  ![image-20220702170000617](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/84.png)

  所以这个容器是无法连接到互联网的：

  ![image-20220702170531312](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/85.png)
...
* **bridge网络：**容器默认使用的网络类型，这是桥接网络，也是应用最广泛的网络类型：
  ...
  ![image-20220702172102410](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/86.png)
  ...
  ![image-20220702172532004](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/87.png)
  ...
  ![image-20220702173005750](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/88.png)
  ...
  ![image-20220702173431530](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/89.png)
...
* **host网络：**当容器连接到此网络后，会共享宿主主机的网络，网络配置也是完全一样的：
  ...
  ![image-20220702170754656](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/90.png)

  只要宿主主机能连接到互联网，容器内部也是可以直接使用的：

  ![image-20220702171041631](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/91.png)
  ...
  ![image-20220702171550979](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/92.png)
...
![image-20220702180837819](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/93.png)
...
![image-20220702181150667](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/94.png)
...
![image-20220702181252137](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/95.png)

成功得到分配的IP地址，是在这个网络内的，注意不同的网络之间是隔离的，我们可以再创建一个容器试试看：

![image-20220702181808792](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/96.png)
...
![image-20220702182050204](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/97.png)

这样就连接了一个新的网络：

![image-20220702182146049](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/98.png)

可以看到容器中新增了一个网络设备连接到我们自己定义的网络中，现在这两个容器在同一个网络下，就可以相互ping了：
![image-20220702182310008](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/99.png)
...
![image-20220702175353454](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/100.png)
...
![image-20220702192457354](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/101.png)
...
![image-20220702200711351](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/102.png)
...
![image-20220702201348722](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/103.png)
...
![image-20220702230700124](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/104.png)
...
![image-20220702231458928](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/105.png)
...
![image-20220702232449520](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/106.png)
...
![image-20220702233420287](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/107.png)

一旦监听到宿主主机的80端口收到了数据包，那么会直接转发给对应的容器。所以配置了端口映射之后，我们才可以从外部正常访问到容器内的服务：

![image-20220630165440751](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/108.png)

我们也可以直接输入`docker ps`查看端口映射情况：

![image-20220702233831651](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/109.png)
...
![image-20220703105256049](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/110.png)
...
![image-20220703105626105](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/111.png)

在宿主主机的对应目录下，可以直接访问到我们刚刚创建好的文件。

接着我们来将容器销毁，看看当容器不复存在时，挂载的数据时候还能保留：

![image-20220703105847329](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/112.png)
...
![image-20220703111937254](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/113.png)
...
![image-20220703112702067](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/114.png)
...
![image-20220703113507320](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/115.png)

可以看到Sorce指向的是`/var/lib`中的某个目录，我们可以进入这个目录来创建一个新的文件，进入之前记得提升一下权限，权限低了还进不去：

![image-20220703114333446](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/116.png)

我们来创一个新的文本文档：

![image-20220703114429831](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/117.png)

实际上和我们之前是一样的，也是可以在容器中看到的，当然删除容器之后，数据依然是保留的。当我们不需要使用数据卷时，可以进行删除：

![image-20220703145011638](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/118.png)

当然有时候为了方便，可能并不需要直接挂载一个目录上去，仅仅是从宿主主机传递一些文件到容器中，这里我们可以使用`cp`命令来完成：

![image-20220703115648195](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/119.png)
...
![image-20220703141840532](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/120.png)
...
![image-20220703142849845](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/121.png)
...
![image-20220703153109650](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/122.png)

现在我们运行一个容器看看：

![image-20220703153343461](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/123.png)

可以看到所有的文件都自动解压出来了（除了中文文件名称乱码了之外，不过无关紧要）我们退出容器，可以看到数据卷列表中新增了我们这个容器需要使用的：

![image-20220703153514730](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/124.png)

![image-20220703153542739](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/125.png)
...
![image-20220701221210083](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/127.png)

当然也可以添加`-f`参数来持续打印日志信息。

![image-20220701215617022](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/128.png)
...
![image-20220701215829492](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/129.png)

注意现在就切换为了容器内的终端，如果想要退出的话，需要先按Ctrl+P然后再按Ctrl+Q来退出终端，不能直接使用Ctrl+C来终止，这样会直接终止掉Docker中运行的Java程序的。

![image-20220701220018207](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/130.png)
...
![image-20220701220601732](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/131.png)

当然也可以仅仅在容器中执行一条命令：

![image-20220701220909626](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/132.png)
...
![image-20220701222537737](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/133.png)

![image-20220701222243900](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/134.png)
...
![image-20220701222323948](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/135.png)
...
![image-20220702104653971](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/136.png)
...
![image-20220702114126128](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/137.png)
...
![image-20220702115538699](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/138.png)
...
![image-20220702115818344](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/139.png)
...
![image-20220702120329140](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/140.png)
...
![image-20220702121839871](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/141.png)
...
![image-20220702122557288](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/142.png)
...
![image-20220702153236692](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/143.png)
...
![image-20220702153704729](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/144.png)
...
![image-20220702153957780](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/145.png)
...
![image-20220702155450772](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/146.png)

OK，开启成功，我们可以直接登录后台面板：https://IP:9443/，这里需要HTTPS访问，浏览器可能会提示不安全，无视就行：

![image-20220702155637366](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/147.png)

![image-20220702155703962](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/148.png)

进入后就需要我们进行注册了，这里我们只需输入两次密码即可，默认用户名就是admin，填写完成后，我们就可以开始使用了：

![image-20220702160124676](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/149.png)

点击Get Started即可进入到管理页面，我们可以看到目前有一个本地的Docker服务器正在运行：

![image-20220702160328972](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/150.png)
...
![image-20220703163126221](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/151.png)
...
![image-20220703175103531](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/152.png)
...
![image-20220703180206437](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/153.png)
...
![image-20220703182541976](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/154.png)

![image-20220703182559020](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/155.png)

看到 Running 4/4 就表示已经部署成功了，我们现在到服务器这边来看看情况：

![image-20220703182657205](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/156.png)

可以看到，这里确实是按照我们的配置，创建了3个容器，并且都是处于运行中，可以正常访问：

![image-20220703182958392](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/157.png)

如果想要结束的话，我们只需要点击停止就行了：

![image-20220703183240400](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/158.png)

当然如果我们不再需要这套环境的话，可以直接点击下方的按钮，将整套编排给down掉，这样的话相对应的容器也会被清理的：

![image-20220703183730693](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/159.png)

![image-20220703183807157](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/160.png)

注意在使用docker-compose部署时，会自动创建一个新的自定义网络，并且所有的容器都是连接到这个自定义的网络里面：

![image-20220703210431690](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/161.png)

这个网络默认也是使用bridge作为驱动：

![image-20220703210531073](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/162.png)
...
![image-20220703215050497](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/163.png)

现在我们重新部署docker-compos吧：

![image-20220703215133786](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/164.png)

当三个服务全部为蓝色时，就表示已经正常运行了，现在我们来测试一下吧：

![image-20220703215211999](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/165.png)

接着我们来试试看向数据库传入数据：

![image-20220703215236719](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/166.png)

![image-20220703215245757](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/167.png)

可以看到响应成功，接着我们来请求一下：

![image-20220703215329690](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/168.png)
...
![image-20220703220941562](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/169.png)

![image-20220703221002195](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Linux/Docker容器技术/170.png)
