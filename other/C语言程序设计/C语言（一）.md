![image-20220531094944782](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/0.jpg)
...
![image-20220531100709841](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/1.jpg)
...
![image-20220531102337270](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/2.jpg)
...
![image-20220531105143154](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/3.jpg)

相信各位熟知的计算机都是一个屏幕+一个主机的形式，然后配上我们的键盘鼠标，就可以开始使用了，但是实际上标准的计算机结构并没有这么简单，我们来看看：

![image-20220531105407595](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/4.jpg)
...
![image-20220531132920027](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/5.jpg)
...
![image-20220531135531352](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/6.jpg)

有了操作系统，我们的电脑才能真正运行起来，我们就可以轻松地通过键盘和鼠标来操作电脑了。

不过操作系统最开始并不是图形化界面，它类似于Windows中的命令提示符：

![image-20220531142155616](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/7.jpg)

![image-20220531142617124](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/8.jpg)
...
![image-20220531142844465](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/9.jpg)
...
![image-20220531144405958](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/10.jpg)
...
![image-20220531150346899](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/11.jpg)
...
![image-20220603123928430](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/12.jpg)

当然，除了C语言之外，还有很多其他的高级语言，比如Java、Python、C#、PHP等等，相比其他编程语言，C算是比较古老的一种了，但是时隔多年直至今日，其他编程语言也依然无法撼动它的王者地位：

![image-20220531151304124](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/13.jpg)
...
![image-20220531155158399](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/14.jpg)

下载完成后我们直接点击安装：

![image-20220531160109168](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/15.jpg)

如果你不是很熟悉，建议直接点Next安装到C盘默认路径，不要去修改，当然如果确实C盘没有空间，那可以自行修改为其他路径，但是注意最好路径中不要出现中文。

![image-20220531160325932](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/16.jpg)

勾选一下创建快捷方式，然后继续点Next等待安装就行了：

![image-20220531160400589](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/17.jpg)

安装完成后，我们可以直接打开：

![image-20220531161024539](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/18.jpg)

这里会提示我们激活，点击按钮去官网注册一个账号。注册完成后，推荐去申请一下学生授权，因为试用只有30天：[Jetbrains学生授权获取指南 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/378185042)

![image-20220531161215214](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/19.jpg)

这里我们点击开始试用，然后就可以点击Continue了，现在成功来到主界面：

![image-20220531161354913](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/20.jpg)

由于是英文，使用不太方便，所以我们安装一下中文插件：

![image-20220531161457379](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/21.jpg)

现在我们就成功安装好CLion集成开发环境了。

![image-20220531161549721](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/22.jpg)

现在我们来创建我们的第一个C语言项目（我们的程序是以一个项目的形式进行管理的，这里知道怎么创建就行了）：

![image-20220531161637209](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/23.jpg)

这里选择C可执行文件，然后项目的保存位置可以自行修改，配置完成后点击创建：

![image-20220531162129788](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/24.jpg)
...
![image-20220531163655149](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/25.jpg)

那么这段示例代码有了，我们如何编译运行呢？

![image-20220531162447514](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/26.jpg)

我们可以点击代码旁边的绿色三角形符号或是右上角的绿色三角形，就可以直接编译运行我们的代码了。运行的结果是在控制台输出一个“HelloWorld！”，当然我们也可以直接运行编译出来的可执行文件：

![image-20220531162638883](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/27.jpg)

我们可以看到，这里生成了一个`项目名称.exe`文件，这种就是Windows环境下可以直接运行的应用程序，我们可以打开这个文件夹，直接使用cmd来运行：

![image-20220531162824734](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（一）/28.jpg)
