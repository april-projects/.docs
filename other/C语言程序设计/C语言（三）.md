![image-20220619215833870](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/0.png)
...
![image-20220619224057060](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/1.png)
...
![image-20220624225026394](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/19.png)
...
![image-20220624232337311](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/22.png)
...
![image-20220625234018499](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/34.png)
...
![image-20220626184248768](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/47.png)
...
![image-20220628112153835](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/49.png)
...
![image-20220628135052152](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/50.png)
...
![image-20220628135806896](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/51.png)
...
![image-20220628135946686](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/52.png)

不过这里要补充一下，文件的读写实际上并不是直接对文件进行操作的，在这之间还有一个缓冲区：

![image-20220628141209105](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/53.png)
...
![image-20220628151553683](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/54.png)
...
![image-20220628152934462](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/55.png)
...
![image-20220627112630649](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/56.png)
...
![image-20220627120949262](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/57.png)

位置在你的`CLion安装目录/bin/mingw/bin`，打开高级系统设置，添加环境变量：

![image-20220627121332125](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/58.png)
...
![image-20220627130234208](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/59.png)

可以看到这里打开的是Windows自带的PowerShell终端，如果不是的可以在设置中修改：

![image-20220627130343946](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/60.png)
...
![image-20220627130740318](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/61.png)

生成后，我们可以直接查看这个文件（因为此时依然是普通文本）可以看到，我们的代码在经过预处理之后，`#include <stdio.h>`中的内容都替换过来了。最下面大约1000行左右的位置就是我们的代码了：

![image-20220627131124121](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/62.png)
...
![image-20220627131513884](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/63.png)
...
![image-20220627131829386](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/64.png)
...
![image-20220627132110465](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/65.png)

![image-20220627132259302](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/66.png)

成功生成.exe文件，我们直接在控制台输入它的名字就可以运行了：

![image-20220627132221190](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/67.png)
...
![image-20220627133429263](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/68.png)
...
![image-20220627133646126](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/69.png)
...
![image-20220627134010138](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/70.png)
...
![image-20220627135232863](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/71.png)
...
![image-20220627212727506](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/72.png)

命令执行的每一步都会详细打印出来，我们可以看到构建确实是按照我们的顺序在进行，并且成功编译出最终目标：

![image-20220627212822806](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/73.png)

当然，如果我们没有做任何的修改，那么再次执行make命令不会做任何事情：

![image-20220627212951245](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/74.png)

但是如果我们修改一下源文件的话，执行make将会重新构建目标：

![image-20220627213029819](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/75.png)

再次执行：

![image-20220627213051247](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/76.png)
...
![image-20220627215908039](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/77.png)
...
![image-20220627221226478](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/78.png)

可以看到已经成功在我们的构建目录中生成了：

![image-20220627221335557](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/79.png)

只不过它这个自动生成的Makefile写的就比较复杂了，我们也不需要去关心，接着我们像之前一样直接使用make就可以编译了：

这里要先进入一下test目录，使用`cd test`命令修改当前工作目录：

![image-20220627221459717](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/80.png)

可以看到它生成的Makefile还是挺高级的，还能输出进度，现在我们的程序就构建好了，直接启动把：

![image-20220627221546242](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/81.png)
...
![image-20220628002518087](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/82.png)
...
![image-20220628002734741](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/83.png)

进入后，可以看到是这样的一个界面，我们需要输入命令来进行逐步调试，输入r就可以开始运行了：

![image-20220628001554755](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/84.png)

成功运行出结果，那么具体怎么进行断点调试呢？我们可以使用`b 行号`的形式在对应的行号打上断点，比如这里对第9行进行断点：

![image-20220628002035160](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/85.png)

接着我们再输入r之后，程序会暂时卡在断点位置，此时我们可以通过输入v来查看当前所有的局部变量信息：

![image-20220628003001093](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/86.png)

可以看到现在是冒泡排序的第一轮，所以`i`和`j`都还是0，并且数组是乱序的，我们输入c可以继续运行：

![image-20220628003056092](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/87.png)

继续运行一轮后，此时`j`就变成1了，因为内层循环执行了一次，我们可以通过p来打印变量的值：

![image-20220628003230535](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/88.png)

当我们不需要再调试时，可以直接结束掉程序：

![image-20220628003631329](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/other/C语言程序设计/C语言（三）/89.png)
