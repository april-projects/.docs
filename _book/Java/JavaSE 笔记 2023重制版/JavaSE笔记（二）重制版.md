![image-20220916174714019](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/0.png)
...
![image-20220916213529426](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/1.png)

只要源代码中存在报错的地方，就无法正常完成编译得到二进制文件，会提示构建失败：

![image-20220916213641899](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/2.png)
...
![image-20220916214557378](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/3.png)

如果两段代码没有加上分号分割，那么编译器会认为这两段代码是同一句代码中的，即使出现换行或者是空格：

![image-20220916214736541](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/4.png)

这里IDEA很聪明，会提醒我们这里少加了分号，所以说这个IDEA能够在初期尽可能地帮助新手。

再比如下面的代码：

![image-20220916214822072](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/5.png)

![image-20220916214929651](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/6.png)
...
![image-20220916221833145](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/7.png)
...
![image-20220916221711430](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/8.png)

但是如果直接写上文字的话，会导致编译不通过，因为这段文字也会被认为是程序的一部分。

这种情况，我们就可以告诉编译器，这段文字是我们做的笔记，并不是程序的一部分，那么要怎么告诉编译器这不是代码呢？很简单，我们只需要在前面加上双斜杠就可以了：

![image-20220916222035778](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/9.png)

添加双斜杠之后（自动变成了灰色），后续的文本内容只要没有发生换行，那么都会被认为是一段注释，并不属于程序，在编译时会被直接忽略，之后这段注释也不会存在于程序中。但是一旦发生换行那就不行了：

![image-20220916222225047](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/10.png)
...
![image-20220916222636943](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/11.png)
...
![image-20220916224129597](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/12.png)
...
![image-20220916225037221](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/13.png)
...
![image-20220916225429474](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/14.png)
...
![image-20220916231650085](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/15.png)
...
![image-20220916232420547](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/16.png)
...
![image-20220916234540720](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/17.png)
...
![image-20220917102209246](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/18.png)
...
![image-20220917105141288](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/19.png)
...
![image-20220917105849862](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/20.png)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/21.png)
...
![image-20220917110854266](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/22.png)
...
![image-20220917111838629](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/23.png)

Java程序在编译为`.class`文件之后，会采用UTF-8的编码格式，支持的字符也非常多，所以你甚至可以直接把变量名写成中文，依然可以编译通过：

![image-20220917112033102](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/24.png)

介绍完了字符之后，我们接着来看看字符串，其实字符串我们在一开始就已经接触到了。字符虽然可以表示一个中文，但是它没办法表示多个字符：

![image-20220917114628564](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/25.png)
...
![image-20220917115424504](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/26.png)
...
![image-20220917141359260](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/27.png)

小数和整数一起计算同样会发生隐式类型转换：

![image-20220917141955891](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/28.png)
...
![image-20220917145901135](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/29.png)
...
![image-20220917150010919](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/30.png)
...
![image-20220917141816599](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/31.png)
...
![image-20220917142201392](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/32.png)
...
![image-20220917150256987](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/33.png)
...
![image-20220917151028191](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/34.png)
...
![image-20220917223047110](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/35.png)
...
![image-20220917224320699](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/36.png)
...
![image-20220917231014796](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/37.png)
...
![image-20220918112006020](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/38.png)

调试模式在我们后面的学习中非常重要，影响深远，所以说各位小伙伴一定要学会。调试也很简单，我们只需要点击右上角的调试选项即可（图标像一个小虫子一样，因为调试的英文名称是Debug）

![image-20220918112101677](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/39.png)

调试开始时，我们可以看到程序在断点位置暂停了：

![image-20220918112227207](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/40.png)

此时我们可以观察到当前的局部变量`i`的值，也可以直接在下方的调试窗口中查看：

![image-20220918112409944](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/41.png)

随着循环的进行，i的值也会逐渐自增：

![image-20220918112628585](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/42.png)
...
![image-20220918112923978](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/43.png)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/44.jpg)

现在我们要做的是在我们的程序中，也打印出这样的一个乘法表出来，请你设计一个Java程序来实现它。

![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（二）重制版/45.jpg)
