![image-20220918121719900](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/0.png)
...
![image-20220919203119479](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/1.png)
...
![image-20220919204004526](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/2.png)

我们在对类进行命名时，一般使用英文单词，并且首字母大写，跟变量命名一样，不能出现任何的特殊字符。

![image-20220919204159248](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/3.png)
...
![image-20220919205550104](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/4.png)
...
![image-20220919211443657](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/5.png)
...
![image-20220919210058797](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/6.png)
...
![image-20220919213732810](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/7.png)
...
![image-20220919214248053](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/8.png)
...
![image-20220920101033325](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/9.png)
...
![image-20220919220837991](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/10.png)
...
![image-20220919222813469](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/11.png)

在`return`后编写代码，会导致编译不通过，因为存在不可达语句。

如果我们的程序中出现了分支语句，那么必须保证每一个分支都有返回值才可以：

![image-20220919223037197](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/12.png)
...
![image-20220919224219071](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/13.png)

我们发现a和b的值并没有发生交换，但是按照我们的方法逻辑来说，应该是会交换才对，这是为什么呢？实际上这里仅仅是将值复制给了函数里面的变量而已（相当于是变量的赋值）

![image-20220919224623727](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/14.png)
...
![image-20220919224957971](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/15.png)
...
![image-20220919225455752](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/16.png)
...
![image-20220920102347110](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/17.png)
...
![image-20220920102933047](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/18.png)
...
![image-20220921001914601](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/19.png)
...
![image-20220920234401275](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/20.png)

因为静态方法属于类的，所以说我们在静态方法中，无法获取成员变量的值：

![image-20220920235418115](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/21.png)
...
![image-20220921000953525](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/22.png)
...
![image-20220921001222465](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/23.png)
...
![image-20220921120040350](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/24.png)

我们可以将类放入到包中：

![image-20220921115055000](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/25.png)
...
![image-20220921120241184](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/26.png)
...
![image-20220921122514457](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/27.png)
...
![image-20220921142724239](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/28.png)
...
![image-20220921150139125](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/29.png)
...
![image-20220921153512798](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/30.png)
...
![image-20220921160309835](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/31.png)
...
![image-20220921160742714](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/32.png)
...
![image-20220921160851193](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/33.png)
...
![image-20220921214642969](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/34.png)
...
![image-20220921214944267](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/35.png)
...
![image-20220921221053801](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/36.png)
...
![image-20220921223249343](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/37.png)
...
![image-20220921224525855](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/38.png)
...
![image-20220921224907373](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/39.png)

或者，如果父类中方法的可见性为`private`，那么子类同样无法访问，也就不能重写，但是可以定义同名方法：

![image-20220921225651487](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/40.png)
...
![image-20220921225234226](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/41.png)
...
![image-20220921225840122](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/42.png)
...
![image-20220921231744420](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/43.png)
...
![image-20220921232435056](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/44.png)
...
![image-20220921234735828](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/45.png)
...
![image-20220922110044636](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/46.png)
...
> ```
>
> ![image-20220922110750697](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/47.png)
>
...
![image-20220922111426974](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（三）重制版/48.png)
