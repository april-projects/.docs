...
![image-20220506214320210](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/0.jpg)
...
![image-20220506222006550](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/1.jpg)
...
![image-20220506224926169](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/2.jpg)
...
![image-20220506224258538](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/3.jpg)
...
![image-20220507102955570](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/4.jpg)

![image-20220507103009255](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/5.jpg)
...
![image-20220507110120090](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/6.jpg)
...
![image-20220507160235552](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/7.jpg)
...
![image-20220507165153381](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/8.jpg)
...
![image-20220507163253662](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/9.jpg)

我们来看看复合模式，复合模式可以任意地拼凑组合其他缓冲区，比如我们可以：

![image-20220507171216323](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/10.jpg)
...
![image-20220512122211805](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/11.jpg)
...
![image-20220512123113806](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/12.jpg)
...
1. 使用虚拟内存
   ...
   ![image-20220512124512936](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/13.jpg)

2. 使用mmap/write内存映射

   实际上这种方式就是将内核空间中的缓存直接映射到用户空间缓存，比如我们之前在学习NIO中使用的MappedByteBuffer，就是直接作为映射存在，当我们需要将数据发送到Socket缓冲区时，直接在内核空间中进行操作就行了：

   ![image-20220512124732995](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/14.jpg)
...
3. 使用sendfile方式
   ...
   ![image-20220512124950007](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/15.jpg)
...
![image-20220509215109408](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/16.jpg)

可以看到，和我们之前介绍的主从Reactor多线程模型非常类似：

![image-20220505131410997](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/17.jpg)
...
![image-20220510092703319](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/18.jpg)
...
![image-20220510094007913](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/19.jpg)
...
![image-20220511152035030](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/20.jpg)
...
![image-20220510130021714](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/21.jpg)
...
![image-20220510133359757](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/22.jpg)
...
![image-20220510144513303](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/23.jpg)
...
![image-20220511123807650](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/24.jpg)
...
![image-20220511124755974](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/25.jpg)
...
![image-20220511124933026](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/26.jpg)
...
![image-20220511130100984](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/27.jpg)
...
![image-20220511130605337](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/28.jpg)

当然，除了编码器和解码器之外，还有编解码器。？？缝合怪？？

![image-20220511130937624](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/29.jpg)
...
![image-20220511133025492](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/30.jpg)
...
![image-20220511142040941](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/31.jpg)

可以看到浏览器成功接收到服务器响应，然后控制台打印了以下类型：

![image-20220511142121619](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/32.jpg)
...
![image-20220511143318500](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/33.jpg)

我们来试试看搞个静态页面代理玩玩，拿出我们的陈年老模板：

![image-20220511144020424](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/34.jpg)
...
![image-20220511150714100](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/35.jpg)
...
![image-20220512125851248](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/36.jpg)
...
![image-20220512130926968](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/37.jpg)
...
![image-20220512131845296](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/java/NIO/Java NIO（二）/38.jpg)
