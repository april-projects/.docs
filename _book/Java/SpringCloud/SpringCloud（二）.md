![image-20220326001448808](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/0.jpg)
...
![image-20220326110940692](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/1.jpg)
...
![image-20220326125206549](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/2.jpg)

可以看到目前最新的版本是`1.4.3`版本（2022年2月27日发布的），我们直接下载`zip`文件即可。

接着我们将文件进行解压，得到以下内容：

![image-20220326125854416](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/3.jpg)

我们直接将其拖入到项目文件夹下，便于我们一会在IDEA内部启动，接着添加运行配置：

![image-20220326130340573](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/4.jpg)
...
![image-20220326132051779](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/5.jpg)

OK，启动成功，可以看到它的管理页面地址也是给我们贴出来了： http://localhost:8848/nacos/index.html，访问这个地址：

![image-20220326132157126](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/6.jpg)

默认的用户名和管理员密码都是`nacos`，直接登陆即可，可以看到进入管理页面之后功能也是相当丰富：

![image-20220326132455674](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/7.jpg)
...
![image-20220326140130226](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/8.jpg)

按照同样的方法，我们接着将另外两个服务也注册到Nacos中：

![image-20220326140618708](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/9.jpg)
...
![image-20220326142331199](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/10.jpg)

测试正常，可以自动发现服务，接着我们来多配置几个实例，去掉图书服务和用户服务的端口配置：

![image-20220326142751398](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/11.jpg)
...
现在将全部服务启动：
![image-20220326142953904](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/12.jpg)

可以看到Nacos中的实例数量已经显示为`2`：

![image-20220326143017054](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/13.jpg)

接着我们调用借阅服务，看看能否负载均衡远程调用：

![image-20220326143058939](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/14.jpg)

![image-20220326143122333](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/15.jpg)

OK，负载均衡远程调用没有问题，这样我们就实现了基于Nacos的服务的注册与发现，实际上大致流程与Eureka一致。

值得注意的是，Nacos区分了临时实例和非临时实例：

![image-20220326155010841](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/16.jpg)
...
![image-20220326155554821](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/17.jpg)

如果这时我们关闭此实例，那么会变成这样：

![image-20220326155633190](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/18.jpg)
...
![image-20220326150024118](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/19.jpg)

因此，我们可以对部署在不同机房的服务进行分区，可以看到实例的分区是默认：

![image-20220326150136538](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/20.jpg)
...
![image-20220326150518357](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/21.jpg)

修改完成之后，我们来尝试重新启动一下（Nacos也要重启），观察Nacos中集群分布情况：

![image-20220326150956937](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/22.jpg)
...
![image-20220326153002500](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/23.jpg)

可以看到，在下线之后，由于本区域内没有可用服务了，借阅服务将会调用重庆区域的用户服务。

除了根据区域优先调用之外，同一个区域内的实例也可以单独设置权重，Nacos会优先选择权重更大的实例进行调用，我们可以直接在管理页面中进行配置：

![image-20220326152659294](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/24.jpg)
...
![image-20220326161111523](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/25.jpg)
...
![image-20220326162108899](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/26.jpg)

完成之后点击发布即可：

![image-20220326162122134](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/27.jpg)
...
![image-20220326163449032](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/28.jpg)
...
![image-20220326164209154](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/29.jpg)

可以看到已经可以正常读取了：

![image-20220326164306032](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/30.jpg)

现在我们将配置文件的值进行修改：

![image-20220326164531412](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/31.jpg)

再次访问接口，会发现没有发生变化：

![image-20220326164549862](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/32.jpg)

但是后台是成功检测到值更新了，但是值却没改变：

![image-20220326164645791](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/33.jpg)
...
![image-20220326172756819](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/34.jpg)

这里我们创建一个新的命名空间：

![image-20220326173744551](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/35.jpg)

可以看到在dev命名空间下，没有任何配置文件和服务：

![image-20220326175340892](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/36.jpg)
...
![deployDnsVipMode.jpg](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/37.jpg)
...
![image-20220326222343802](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/38.jpg)
...
![image-20220326222728745](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/39.jpg)

我们来将其导入到数据库，可以看到生成了很多的表：

![image-20220326222957239](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/40.jpg)

然后我们来创建两个Nacos服务器，做一个迷你的集群，这里使用`scp`命令将nacos服务端上传到Linux服务器（注意需要提前安装好JRE 8或更高版本的环境）：

![image-20220327115901662](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/41.jpg)
...
![image-20220327120219022](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/42.jpg)

端口记得使用内网IP地址：

![image-20220327142541523](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/43.jpg)

最后我们修改一下Nacos的内存分配以及前台启动，直接修改`startup.sh`文件（内存有限，玩不起高的）：

![image-20220327125049013](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/44.jpg)

保存之后，将nacos复制一份，并将端口修改为8802，接着启动这两个Nacos服务器。

![image-20220327125201913](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/45.jpg)

然后我们打开管理面板，可以看到两个节点都已经启动了：

![image-20220327125232238](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/46.jpg)
...
![image-20220327130009391](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/47.jpg)
...
![image-20220327144441878](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/48.jpg)

然后我们将所有的服务全部修改为云服务器上Nacos的地址，启动试试看。

![image-20220327145216771](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/49.jpg)

这样，我们就搭建好了Nacos集群。

***

![image-20220327153016414](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/50.jpg)
...
![image-20220327154616456](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/51.jpg)

注意下载下来之后是一个`jar`文件（其实就是个SpringBoot项目），我们需要在IDEA中添加一些运行配置：

![image-20220327163002399](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/52.jpg)

接着就可以直接启动啦，当然默认端口占用8080，如果需要修改，可以添加环境变量：

![image-20220327163110733](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/53.jpg)

启动之后，就可以访问到Sentinel的监控页面了，用户名和密码都是`sentinel`，地址：http://localhost:8858/#/dashboard

![image-20220327163206117](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/54.jpg)
...
![image-20220327164111325](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/55.jpg)

![image-20220327164336877](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/56.jpg)
...
1. **漏桶算法**
   ...
   ![image-20220327172014949](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/57.jpg)
...
2. **令牌桶算法**
   ...
   ![image-20220327173323339](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/58.jpg)
...
3. **固定时间窗口算法**
   ...
   ![image-20220327174027199](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/59.jpg)
...
4. **滑动时间窗口算法**
   ...
   ![image-20220327174906227](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/60.jpg)

   虽然这样能够避免固定时间窗口的临界问题，但是这样显然是比固定窗口更加耗时的。

好了，了解完了我们的限流策略和判定方法之后，我们在Sentinel中进行实际测试一下，打开管理页面的簇点链路模块：

![image-20220327175131519](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/61.jpg)
...
![image-20220327175821941](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/62.jpg)
...
![image-20220327182851278](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/63.jpg)

注意限流是作用于关联资源的，一旦发现关联资源超过阈值，那么就会对当前的资源进行限流，我们现在来测试一下，这里使用PostMan的Runner连续对关联资源发起请求：

![image-20220327183241316](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/64.jpg)

开启Postman，然后我们会发现借阅服务已经凉凉：

![image-20220327183331595](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/65.jpg)
...
![image-20220328112645048](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/66.jpg)
...
![image-20220328112949894](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/67.jpg)

然后我们会发现，限流效果只对我们配置的链路接口有效，而其他链路是不会被限流的。

除了直接对接口进行限流规则控制之外，我们也可以根据当前系统的资源使用情况，决定是否进行限流：

![image-20220328235217680](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/68.jpg)
...
![image-20220328153755461](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/69.jpg)
...
![image-20220328154430549](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/70.jpg)
...
![image-20220328161940219](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/71.jpg)
...
![image-20220328145654180](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/72.jpg)

然后开始访问我们的测试接口，可以看到在携带参数a时，当访问频率超过设定值，就会直接被限流，这里是直接在后台抛出异常：

![image-20220328145726479](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/73.jpg)

![image-20220328145851133](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/74.jpg)

而我们使用其他参数或是不带`a`参数，那么就不会出现这种问题了：

![image-20220328145838378](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/75.jpg)

除了直接对某个参数精准限流外，我们还可以对参数携带的指定值单独设定阈值，比如我们现在不仅希望对参数`a`限流，而且还希望当参数`a`的值为10时，QPS达到5再进行限流，那么就可以设定例外：

![image-20220328150138096](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/76.jpg)
...
![image-20220324141706946](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/77.jpg)
...
1. **线程池隔离**
   ...
   ![image-20220328121932455](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/78.jpg)
...
![image-20220328124619289](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/79.jpg)
...
![image-20220328125115760](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/80.jpg)
...
1. **慢调用比例：**如果出现那种半天都处理不完的调用，有可能就是服务出现故障，导致卡顿，这个选项是按照最大响应时间（RT）进行判定，如果一次请求的处理时间超过了指定的RT，那么就被判定为`慢调用`，在一个统计时长内，如果请求数目大于最小请求数目，并且被判定为`慢调用`的请求比例已经超过阈值，将触发熔断。经过熔断时长之后，将会进入到半开状态进行试探（这里和Hystrix一致）
   ...
   ![image-20220328131105084](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/81.jpg)

   可以看到，超时直接触发了熔断，进入到阻止页面：

   ![image-20220328131018951](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/82.jpg)
...
2. **异常比例：**这个与慢调用比例类似，不过这里判断的是出现异常的次数，与上面一样，我们也来进行一些小测试：
   ...
   ![image-20220328132443315](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/83.jpg)

   现在我们进行访问，会发现后台疯狂报错，然后就熔断了：

   ![image-20220328132815856](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/84.jpg)

   ![image-20220328132804164](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/85.jpg)

3. **异常数：**这个和上面的唯一区别就是，只要达到指定的异常数量，就熔断，这里我们修改一下熔断规则：

   ![image-20220328132927745](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/86.jpg)
...
![image-20220328160248977](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/88.jpg)

OK，可以看到熔断之后，服务降级之后的效果：

![image-20220328160112038](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/89.jpg)
...
![image-20220328165606119](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/90.jpg)
...
![image-20220329112537891](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/91.jpg)
...
![image-20220329111304542](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/92.jpg)

上面这种情况时间就是一种多服务多数据源的分布式事务模型（比较常见），因此，为了解决这种情况，我们就得实现分布式事务，让这整个流程保证原子性。

SpringCloud Alibaba为我们提供了用于处理分布式事务的组件Seata。

![image-20220329113049408](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/93.jpg)
...
![image-20220329135048063](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/94.jpg)

然后修改书籍信息，也是直接添加一个字段用于记录剩余数量：

![image-20220329135307659](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/95.jpg)
...
![image-20220329151445740](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/96.jpg)

再次尝试借阅，后台会直接报错：

![image-20220329151512871](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/97.jpg)

抛出异常，但是我们发现一个问题，借阅信息添加失败了，但是图书的数量依然被-1，也就是说正常情况下，我们是希望中途出现异常之后，之前的操作全部回滚的：

![image-20220329151615894](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/98.jpg)
...
1. **XA分布式事务协议 - 2PC（两阶段提交实现）**
   ...
   ![image-20220331214050440](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/99.jpg)
...
![image-20220401144916943](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/100.jpg)
...
* Saga：用于处理长事务，每个执行者需要实现事务的正向操作和补偿操作：
  ...
  ![image-20220401150544921](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/101.jpg)
...
![image-20220331150441431](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/102.jpg)
...
![image-20220331153615187](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/103.jpg)

![image-20220331153823961](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/104.jpg)

首先第一次肯定是正常完成借阅操作的，接着我们再次进行请求，肯定会出现异常：

![image-20220331153655710](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/105.jpg)

![image-20220331153729453](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/106.jpg)

如果能在栈追踪信息中看到seata相关的包，那么说明分布式事务已经开始工作了，通过日志我们可以看到，出现了回滚操作：

![image-20220331153911759](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/107.jpg)

并且数据库中确实是回滚了扣除操作：

![image-20220331153852374](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/108.jpg)
...
![image-20220331155823306](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/109.jpg)
...
![image-20220331160748379](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/110.jpg)

按照提示输入就可以了，不输入就使用的默认值，不知道为啥最新版本有四个因为参数过长还导入失败了，就离谱，不过不影响。

导入成功之后，可以在对应的命名空间下看到对应的配置（为啥非要一个一个配置项单独搞，就不能写一起吗）：

![image-20220331160918380](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/111.jpg)

注意，还没完，我们还需要将对应的事务组映射配置也添加上，DataId格式为`service.vgroupMapping.事务组名称`，比如我们就使用默认的名称，值全部依然使用default即可：

![image-20220331161119169](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/112.jpg)
...
![image-20220331162215864](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/113.jpg)

![image-20220331162241748](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/114.jpg)

接着我们就可以访问一下服务试试看了：

![image-20220331162601073](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/115.jpg)
...
![image-20220331162840368](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/116.jpg)
...
![image-20220331163100436](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/117.jpg)
...
![image-20220331163823920](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/118.jpg)

完成之后，重启Seata服务端即可：

![image-20220331164449635](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/119.jpg)

看到了数据源初始化成功，现在已经在使用数据库进行会话存储了。

如果Seata服务端出现报错，可能是我们自定义事务组的名称太长了：

![image-20220331165020756](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/120.jpg)

将`globle_table`表的字段`transaction_server_group`长度适当增加一下即可：

![image-20220331165103414](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（二）/121.jpg)
