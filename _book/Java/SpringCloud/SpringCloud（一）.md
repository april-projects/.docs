![image-20220317173734208](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/0.jpg)
...
![image-20220320174622739](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/1.jpg)
...
![image-20220322090754438](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/2.jpg)
...
![image-20220322102706256](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/3.jpg)
...
![image-20220323105531867](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/4.jpg)

然后不需要勾选任何依赖，直接创建即可，项目创建完成并初始化后，我们删除父工程的无用文件，只保留必要文件，像下面这样：

![image-20220323105859454](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/5.jpg)

接着我们就可以按照我们划分的服务，进行子工程创建了，创建一个新的Maven项目，注意父项目要指定为我们一开始创建的的项目，子项目命名随意：

![image-20220323110133466](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/6.jpg)

子项目创建好之后，接着我们在子项目中创建SpringBoot的启动主类：

![image-20220323110756722](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/7.jpg)

接着我们点击运行，即可启动子项目了，实际上这个子项目就一个最简单的SpringBoot web项目，注意启动之后最下方有弹窗，我们点击"使用 服务"，这样我们就可以实时查看当前整个大项目中有哪些微服务了：

![image-20220323110917997](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/8.jpg)

![image-20220323111056940](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/9.jpg)

接着我们以同样的方法，创建其他的子项目，注意我们最好将其他子项目的端口设置得不一样，不然会导致端口占用，我们分别为它们创建`application.yml`文件：

![image-20220323111733605](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/10.jpg)

接着我们来尝试启动一下这三个服务，正常情况下都是可以直接启动的：

![image-20220323111849846](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/11.jpg)
...
![image-20220323112340995](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/12.jpg)

![image-20220323112616538](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/13.jpg)

![image-20220323112842758](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/14.jpg)

![image-20220323112750936](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/15.jpg)

![image-20220323112825430](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/16.jpg)

创建好之后，结果如下，一共三张表，各位可以自行添加一些数据到里面，这就不贴出来了：

![image-20220323112922396](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/17.jpg)
...
![image-20220323133820304](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/18.jpg)
...
![image-20220323134742618](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/19.jpg)
...
![image-20220323140053749](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/20.jpg)

但是这显然是违反我们之前所说的单一职责的，相同的业务功能不应该重复出现，但是现在由需要在此服务中查询用户的信息和图书信息，那怎么办呢？我们可以让一个服务去调用另一个服务来获取信息。

![image-20220323140322502](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/21.jpg)
...
![image-20220323141919836](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/22.jpg)
...
![image-20220323143753567](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/23.jpg)
...
![image-20220323145051821](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/24.jpg)
...
![image-20220323152537322](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/25.jpg)
...
![image-20220323154722373](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/26.jpg)
...
![image-20220323155305545](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/27.jpg)

当我们的服务启动之后，会每隔一段时间跟Eureka发送一次心跳包，这样Eureka就能够感知到我们的服务是否处于正常运行状态。

现在我们用同样的方法，将另外两个微服务也注册进来：

![image-20220323155948425](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/28.jpg)
...
![image-20220323161809122](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/29.jpg)
...
![image-20220323162858616](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/30.jpg)

![image-20220323162926482](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/31.jpg)

可以看到，在Eureka中，同一个服务出现了两个实例：

![image-20220323163010052](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/32.jpg)
...
![image-20220323163335257](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/33.jpg)

可以看到，两个实例都能够均匀地被分配请求：

![image-20220323163448765](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/34.jpg)

![image-20220323163457877](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/35.jpg)
...
![image-20220323205531185](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/36.jpg)
...
![image-20220323210218653](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/37.jpg)

对创建的两个配置文件分别添加启动配置，直接使用`spring.profiles.active`指定启用的配置文件即可：

![image-20220323212308857](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/38.jpg)

接着启动这两个注册中心，这两个Eureka管理页面都可以被访问，我们访问其中一个：

![image-20220323210937341](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/39.jpg)

![image-20220323210619533](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/40.jpg)
...
![image-20220323211032311](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/41.jpg)

接着我们模拟一下，将其中一个Eureka服务器关闭掉，可以看到它会直接变成不可用状态：

![image-20220323211354516](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/42.jpg)
...
![image-20220323220519463](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/43.jpg)

![image-20220323220548051](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/44.jpg)
...
![image-20220324120741736](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/45.jpg)
...
![image-20220324221750289](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/46.jpg)

![image-20220324221713964](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/47.jpg)
...
![image-20220324181614387](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/48.jpg)

并且我们可以观察一下两个用户微服务的调用情况，也是以负载均衡的形式进行的。

按照同样的方法，我们接着将图书管理服务的调用也改成接口形式：

![image-20220324181740566](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/49.jpg)
...
![image-20220324181910173](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/50.jpg)
...
![image-20220324141230070](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/51.jpg)

由于位于最底端的服务提供者E发生故障，那么此时会直接导致服务ABCD全线崩溃，就像雪崩了一样。

![image-20220324141706946](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/52.jpg)
...
![image-20220324150253610](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/53.jpg)

![image-20220324150310955](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/54.jpg)
...
![image-20220324152044551](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/55.jpg)
...
![image-20220324152750797](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/56.jpg)
...
![image-20220324153044583](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/57.jpg)

可以看到，当另外两个服务正常运行之后，当再次尝试调用`findUserBorrows`之后会成功，于是熔断机制就关闭了，服务恢复运行。

总结一下：

![image-20220324153935858](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/58.jpg)
...
![image-20220325122629016](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/59.jpg)

![image-20220325122301779](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/60.jpg)
...
![image-20220324225633805](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/61.jpg)
...
![image-20220324225733550](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/62.jpg)
...
![image-20220324230515009](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/63.jpg)

可以看到现在都是Loading状态，这是因为还没有开始统计，我们现在尝试调用几次我们的服务：

![image-20220324230559068](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/64.jpg)

可以看到，在调用之后，监控页面出现了信息：

![image-20220324230703600](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/65.jpg)

可以看到5次访问都是正常的，所以显示为绿色，接着我们来尝试将图书服务关闭，这样就会导致服务降级甚至熔断，然后再多次访问此服务看看监控会如何变化：

![image-20220324230923472](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/66.jpg)

可以看到，错误率直接飙升到100%，并且一段时间内持续出现错误，中心的圆圈也变成了红色，我们继续进行访问：

![image-20220324231022133](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/67.jpg)
...
![image-20220324164439809](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/68.jpg)
...
![image-20220325130147758](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/69.jpg)
...
![image-20220324170951878](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/70.jpg)
...
![image-20220325150924472](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/71.jpg)

这是因为没有找到适用于此架构的动态链接库，不影响使用，无视即可，希望以后的版本能修复吧。

可以看到，我们现在可以直接通过路由来访问我们的服务了：

![image-20220324171724493](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/72.jpg)

注意此时依然可以通过原有的服务地址进行访问：

![image-20220324171909828](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/73.jpg)
...
![image-20220325150730814](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/74.jpg)

![image-20220325151220776](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/75.jpg)
...
![image-20220325154443063](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/76.jpg)

![image-20220325154508853](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/77.jpg)
...
![image-20220325171754862](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/78.jpg)
...
![image-20220325173932623](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/79.jpg)

这里我们以本地仓库为例（就不用GitHub了，卡到怀疑人生了），首先在项目目录下创建一个本地Git仓库，打开终端，在桌面上创建一个新的本地仓库：

![image-20220325220843990](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/80.jpg)

然后我们在文件夹中随便创建一些配置文件，注意名称最好是{服务名称}-{环境}.yml：

![image-20220325221411834](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/81.jpg)
...
![image-20220325221946363](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/82.jpg)

也可以使用 http://localhost:8700/main/bookservice-prod.yml 链接，它仅显示配置文件原文：

![image-20220325222309095](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/83.jpg)
...
![image-20220325224708591](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/84.jpg)
...
![image-20220325230915356](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（一）/85.jpg)
