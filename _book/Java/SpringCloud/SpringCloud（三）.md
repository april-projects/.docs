...
![image-20220401220634827](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/0.jpg)
...
![image-20220402111827054](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/1.jpg)
...
![image-20220402105512397](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/2.jpg)
...
![image-20220402105638986](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/3.jpg)

可以看到三个服务都正常注册了，接着我们去访问图书服务：

![image-20220402105803658](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/4.jpg)
...
![image-20220402110245827](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/5.jpg)

同时用户服务也能正常访问了：

![image-20220402110328674](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/6.jpg)

我们可以查看一下Redis服务器中是不是存储了我们的Session信息：

![image-20220402110416031](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/7.jpg)

虽然看起来好像确实没啥问题了，但是借阅服务炸了，我们来看看为什么：

![image-20220402110519893](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/8.jpg)
...
![image-20220408223238760](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/9.jpg)
...
1. **客户端模式（Client Credentials）**
   ...
   ![image-20220409213716233](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/10.jpg)
...
2. **密码模式（Resource Owner Password Credentials）**
   ...
   ![image-20220409213646255](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/11.jpg)
...
3. **隐式授权模式（Implicit Grant）**
   ...
   ![image-20220409211722092](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/12.jpg)
...
4. **授权码模式（Authrization Code）**
   ...
   ![image-20220409223317823](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/13.jpg)
...
![image-20220410123941157](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/14.jpg)
...
![image-20220410125437766](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/15.jpg)

发起请求后，可以看到我们得到了Token，它是以JSON格式给到我们的：

![image-20220410125831300](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/16.jpg)

我们还可以访问 http://localhost:8500/sso/oauth/check_token 来验证我们的Token是否有效：

![image-20220410130204734](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/17.jpg)

![image-20220410130223312](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/18.jpg)

可以看到active为true，表示我们刚刚申请到的Token是有效的。

接着我们来测试一下第二种password模式，我们还需要提供具体的用户名和密码，授权模式定义为password即可：

![image-20220410130958929](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/19.jpg)

接着我们需要在请求头中添加Basic验证信息，这里我们直接填写id和secret即可：

![image-20220410130819980](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/20.jpg)

可以看到在请求头中自动生成了Basic验证相关内容：

![image-20220410130942662](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/21.jpg)

![image-20220410131048992](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/22.jpg)

响应成功，得到Token信息，并且这里还多出了一个refresh_token，这是用于刷新Token的，我们之后会进行讲解。

![image-20220410131641887](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/23.jpg)
...
![image-20220410132507626](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/24.jpg)

但是登录之后我们发现出现了一个错误：

![image-20220410132557704](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/25.jpg)
...
![image-20220410132927907](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/26.jpg)

可以看到这里会让我们选择哪些范围进行授权，就像我们在微信小程序中登陆一样，会让我们授予用户信息权限、支付权限、信用查询权限等，我们可以自由决定要不要给客户端授予访问这些资源的权限，这里我们全部选择授予：

![image-20220410133106639](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/27.jpg)

授予之后，可以看到浏览器被重定向到我们刚刚指定的回调地址中，并且携带了Token信息，现在我们来校验一下看看：

![image-20220410133210183](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/28.jpg)
...
![image-20220410133411554](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/29.jpg)
...
![image-20220410133702534](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/30.jpg)

可以看到结果也是正常返回了Token信息：

![image-20220410133940312](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/31.jpg)

这样我们四种最基本的Token请求方式就实现了。

最后还有一个是刷新令牌使用的，当我们的Token过期时，我们就可以使用这个refresh_token来申请一个新的Token：

![image-20220410140759967](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/32.jpg)

但是执行之后我们发现会直接出现一个内部错误：

![image-20220410140822286](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/33.jpg)

![image-20220410140838064](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/34.jpg)
...
![image-20220410141143519](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/35.jpg)
...
![image-20220410144654362](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/36.jpg)

可以看到在发现没有登录验证时，会直接跳转到授权页面，进行授权登录，之后才可以继续访问图书服务：

![image-20220410144806506](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/37.jpg)
...
![image-20220410145224153](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/38.jpg)
...
![image-20220410160648326](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/39.jpg)
...
![image-20220411090932561](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/40.jpg)
...
![image-20220411091259795](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/41.jpg)

另一种我们需要使用Postman来完成：

![image-20220411091514501](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/42.jpg)

添加验证信息后，会帮助我们转换成请求头信息：

![image-20220411091655947](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/43.jpg)

![image-20220411091722652](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/44.jpg)
...
![image-20220411092852367](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/45.jpg)
...
![image-20220411115958560](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/46.jpg)
...
![image-20220411124509007](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/47.jpg)
...
![image-20220411132756540](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/48.jpg)
...
![image-20220411133819847](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/49.jpg)
...
![image-20220411135612728](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/50.jpg)
...
![image-20220411143628451](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/51.jpg)
...
![image-20220412083957167](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/52.jpg)
...
![image-20220412113124880](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/53.jpg)
...
![image-20220412115919019](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/54.jpg)

可以看到成功获取了AccessToken，但是这里的格式跟我们之前的格式就大不相同了，因为现在它是JWT令牌，我们可以对其进行一下Base64解码：

![image-20220412120136453](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/55.jpg)
...
![image-20220412120350331](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/56.jpg)

请求成功，得到数据：

![image-20220412120417005](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/57.jpg)

注意如果Token有误，那么会得到：

![image-20220412120441794](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/58.jpg)
...
![image-20220412161901616](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/59.jpg)
...
![image-20220413115227344](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/60.jpg)

现在我们的两个服务器就启动成功了，接着我们可以使用命令查看当前服务器的主从状态，我们打开客户端：

![image-20220413115458597](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/61.jpg)

输入`info replication`命令来查看当前的主从状态，可以看到默认的角色为：master，也就是说所有的服务器在启动之后都是主节点的状态。那么现在我们希望让6002作为从节点，通过一个命令即可：

![image-20220413115722765](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/62.jpg)

可以看到，在输入`replicaof 127.0.0.1 6001`命令后，就会将6001服务器作为主节点，而当前节点作为6001的从节点，并且角色也会变成：slave，接着我们来看看6001的情况：

![image-20220413115959759](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/63.jpg)
...
![image-20220413120133934](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/64.jpg)

可以看到，我们在6001服务器插入的`a`，可以在从节点6002读取到，那么，从节点新增的数据在主节点能得到吗？我们来测试一下：

![image-20220413120235138](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/65.jpg)

可以看到，从节点压根就没办法进行数据插入，节点的模式为只读模式。那么如果我们现在不想让6002作为6001的从节点了呢？

![image-20220413124021549](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/66.jpg)

可以看到，通过输入`replicaof no one`，即可变回Master角色。接着我们再来启动一台6003服务器，流程是一样的：

![image-20220413121338391](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/67.jpg)
...
![image-20220413122411006](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/68.jpg)

但是从节点会疯狂报错：

![image-20220413122528096](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/69.jpg)
...
![image-20220413122848685](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/70.jpg)

当然，除了作为Master节点的从节点外，我们还可以将其作为从节点的从节点，比如现在我们让6003作为6002的从节点：

![image-20220413123047711](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/71.jpg)

也就是说，现在差不多是这样的的一个情况：

![image-20220413123603650](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/72.jpg)
...
![image-20220413154102800](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/73.jpg)
...
![image-20220413155459399](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/74.jpg)
...
![image-20220413161154185](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/75.jpg)

![image-20220413161306103](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/76.jpg)

可以看到以哨兵模式启动后，会自动监控主节点，然后还会显示那些节点是作为从节点存在的。

现在我们直接把主节点关闭，看看会发生什么事情：

![image-20220413161730035](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/77.jpg)

可以看到从节点还是正常的在报错，一开始的时候不会直接重新进行选举而是继续尝试重连（因为有可能只是网络小卡一下，没必要这么敏感），但是我们发现，经过一段时间之后，依然无法连接，哨兵输出了以下内容：

![image-20220413161843439](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/78.jpg)

可以看到哨兵发现主节点已经有一段时间不可用了，那么就会开始进行重新选举，6003节点被选为了新的主节点，并且之前的主节点6001变成了新的主节点的从节点：

![image-20220413162259056](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/79.jpg)

![image-20220413162310821](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/80.jpg)

当我们再次启动6001时，会发现，它自动变成了6003的从节点，并且会将数据同步过来：

![image-20220413163527235](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/81.jpg)
...
![image-20220413201201051](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/82.jpg)

现在我们把6001节点挂掉，看看这三个哨兵会怎么样：

![image-20220413203351360](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/83.jpg)
...
![image-20220413211725149](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/84.jpg)
...
![image-20220413215928157](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/85.jpg)

输入之后，会为你展示客户端默认分配的方案，并且会询问你当前的方案是否合理。可以看到6001/6002/6003都被选为主节点，其他的为从节点，我们直接输入yes即可：

![image-20220413215243309](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/86.jpg)

最后分配成功，可以看到插槽的分配情况：

![image-20220413215958201](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/87.jpg)

现在我们随便连接一个节点，尝试插入一个值：

![image-20220413220609800](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/88.jpg)

在插入时，出现了一个错误，实际上这就是因为a计算出来的哈希值（插槽），不归当前节点管，我们得去管这个插槽的节点执行，通过上面的分配情况，我们可以得到15495属于节点6003管理：

![image-20220413220811536](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/89.jpg)

在6003节点插入成功，当然我们也可以使用集群方式连接，这样我们无论在哪个节点都可以插入，只需要添加`-c`表示以集群模式访问：

![image-20220413220935678](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/90.jpg)

可以看到，在6001节点成功对a的值进行了更新，只不过还是被重定向到了6003节点进行插入。

我们可以输入`cluster nodes`命令来查看当前所有节点的信息：

![image-20220413222104845](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/91.jpg)

那么现在如果我们让某一个主节点挂掉会怎么样？现在我们把6001挂掉：

![image-20220413223237962](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/92.jpg)

可以看到原本的6001从节点7001，晋升为了新的主节点，而之前的6001已经挂了，现在我们将6001重启试试看：

![image-20220413223337494](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/93.jpg)

可以看到6001变成了7001的从节点，那么要是6001和7001都挂了呢？

![image-20220413223702884](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/94.jpg)

这时我们尝试插入新的数据：

![image-20220413223724440](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/95.jpg)

可以看到，当存在节点不可用时，会无法插入新的数据，现在我们将6001和7001恢复：

![image-20220413223813370](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/96.jpg)
...
![image-20220414105646460](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/97.jpg)

可以看到，当客户端1设定a之后，客户端2使用`setnx`会直接失败。

![image-20220414105854959](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/98.jpg)
...
![image-20220414111008456](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/99.jpg)

当然，添加了过期时间，带了的好处是显而易见的，但是同时也带来了很多的麻烦，我们来设想一下这种情况：

![image-20220414112359738](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/100.jpg)
...
![image-20220414113041835](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/101.jpg)
...
![image-20220414113709773](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/102.jpg)
...
![image-20220414133258227](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/103.jpg)
...
![image-20220414133403403](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/104.jpg)
...
![image-20220414162319865](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/105.jpg)
...
![image-20220414164943974](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/106.jpg)
...
![image-20220414170022303](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/107.jpg)
...
![image-20220414192045320](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/108.jpg)
...
![image-20220414192508849](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/109.jpg)
...
![image-20220414192829536](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/110.jpg)

现在我们随便插入一点数据：

![image-20220414192920277](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/111.jpg)

这样，我们的MySQL主从就搭建完成了，那么如果主机此时挂了会怎么样？

![image-20220414200140191](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/112.jpg)
...
* **垂直拆分：**我们的表和数据库都可以进行垂直拆分，所谓垂直拆分，就是将数据库中所有的表，按照业务功能拆分到各个数据库中（是不是感觉跟前面两章的学习的架构对应起来了）而对于一张表，也可以通过外键之类的机制，将其拆分为多个表。
  ...
  ![image-20220414204703883](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/113.jpg)

* **水平拆分：**水平拆分针对的不是表，而是数据，我们可以让很多个具有相同表的数据库存放一部分数据，相当于是将数据分散存储在各个节点上。

  ![image-20220414205222383](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/114.jpg)
...
![image-20220414214856875](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/115.jpg)
...
![image-20220414212443482](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/116.jpg)
...
![image-20220414222958901](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/117.jpg)
...
![image-20220415104401263](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/118.jpg)

测试通过，我们来看看数据库里面是不是按照我们的规则进行数据插入的：

![image-20220415104449502](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/119.jpg)

可以看到这两张表，都成功按照我们指定的路由规则进行插入了，我们来看看详细的路由情况，通过控制台输出的SQL就可以看到：

![image-20220415105325917](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/120.jpg)
...
![image-20220415110322981](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/121.jpg)
...
![image-20220415112809843](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/122.jpg)

可以看到，根据我们的算法，原本的逻辑表被修改为了最终进行分表计算后的结果，我们来查看一下数据库：

![image-20220415112908760](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/123.jpg)
...
![image-20220415113139917](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/124.jpg)
...
![image-20220415113530971](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/125.jpg)
...
![image-20220415113652038](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/126.jpg)
...
2. **雪花算法（Snowflake）：**
   ...
   ![image-20220415150713707](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/127.jpg)
...
![image-20220415154524545](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/128.jpg)
...
![image-20220415155842834](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/129.jpg)
...
![image-20220415160249024](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/130.jpg)
...
![image-20220415162741466](https://cdn.jsdelivr.net/gh/april-projects/.docs/img/Java/SpringCloud/SpringCloud（三）/131.jpg)
