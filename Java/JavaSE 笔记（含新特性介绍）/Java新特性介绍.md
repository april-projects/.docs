![image-20220528201059618](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/0.jpg)
...
![image-20220528202952628](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/1.jpg)
...
![image-20220528220146662](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/2.jpg)
...
> ```
>
> ![image-20220529214948350](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/3.jpg)
>
...
![image-20220528210803658](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/4.jpg)

而在引入模块机制之后：

![image-20220528210958964](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/5.jpg)
...
![image-20220528213210752](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/6.jpg)

程序可以正常运行，貌似和之前没啥区别，不过我们发现，JDK为我们提供的某些框架不见了：

![image-20220528213428296](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/7.jpg)
...
![image-20220528214247006](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/8.jpg)

![image-20220528214308194](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/9.jpg)
...
![image-20220528221817482](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/10.jpg)
...
![image-20220528230842617](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/11.jpg)

这里我们将`com.test`包下所有内容都暴露出去，默认情况下所有的包都是私有的，就算其他项目将此项目作为依赖也无法使用。

接着我们现在想要在项目B中使用项目A的User类，我们需要进行导入：

![image-20220528232033318](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/12.jpg)
...
![image-20220529103614788](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/13.jpg)
...
![image-20220529103828560](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/14.jpg)
...
![image-20220529104451040](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/15.jpg)
...
![image-20220529112208486](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/16.jpg)
...
![image-20220529112707958](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/17.jpg)
...
![image-20220529112909452](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/18.jpg)
...
![image-20220529141547082](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/19.jpg)

环境配置完成后，我们只需要输入`jshell`命令即可开启交互式编程了，它支持我们一条一条命令进行操作。

比如我们来做一个简单的计算：

![image-20220529141719363](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/20.jpg)

我们一次输入一行（可以不加分号），先定义一个a=10和b=10，然后定义c并得到a+b的结果，可以看到还是非常方便的，但是注意语法还是和Java是一样的。

![image-20220529141954494](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/21.jpg)

我们也可以快速创建一个方法供后续的调用。当我们按下Tab键还可以进行自动补全：

![image-20220529142340030](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/22.jpg)

除了直接运行我们写进去的代码之外，它还支持使用命令，输入`help`来查看命令列表：

![image-20220529142440584](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/23.jpg)

比如我们可以使用`/vars`命令来展示当前定义的变量列表：

![image-20220529142757286](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/24.jpg)

当我们不想使用jshell时，直接输入`/exit`退出即可：

![image-20220529142852920](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/25.jpg)
...
![image-20220529144905646](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/26.jpg)
...
![image-20220529171216795](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/27.jpg)
...
![image-20220529170538383](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/28.jpg)

并且`var`关键字仅适用于局部变量，我们是没办法在其他地方使用的，比如类的成员变量：

![image-20220529171444062](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/29.jpg)
...
![image-20220529235822891](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/30.jpg)

但是实际上这里是完全可以进行类型推断的，所以在Java 11，终于是支持了，这样编写就不会报错了：

![image-20220529235935071](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/31.jpg)
...
![image-20220530112549225](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/32.jpg)

网站地址：https://pic.netbian.com/4kmeinv/

我们随便点击一张壁纸，发现网站的URL格式为：

![image-20220530112701156](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/33.jpg)
...
![image-20220530113039571](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/34.jpg)

接着我们需要来观察一下网站的HTML具体怎么写的，把图片的地址提取出来：

![image-20220530113136156](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/35.jpg)
...
![image-20220530114824605](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/36.jpg)
...
![image-20220530120729757](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/37.jpg)
...
![image-20220530222918174](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/38.jpg)
...
![image-20220530230225037](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/39.jpg)

可以看到，Java中也可以使用这样的三引号来表示字符串了，并且我们可以随意在里面使用特殊字符，包括双引号等，但是最后编译出来的结果实际上还是会变成一个之前这样使用了转义字符的字符串：

![image-20220530230343933](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/40.jpg)
...
![image-20220530232252253](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/41.jpg)
...
![image-20220530232755797](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/42.jpg)
...
![image-20220530233031005](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/43.jpg)
...
![image-20220530235609885](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/44.jpg)

并且toString也是被重写了的：

![image-20220530235719341](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/45.jpg)
...
![image-20220531090136485](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/46.jpg)

![image-20220531090152743](https://tencent.cos.mobaijun.com/img/gitbook/java//Java新特性介绍/47.jpg)
