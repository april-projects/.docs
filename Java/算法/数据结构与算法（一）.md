![image-20220709170114962](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/0.png)
...
![image-20220709170248015](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/1.png)
...
![image-20220710103307583](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/2.png)
...
![image-20220709223103628](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/3.png)
...
![image-20220709230756755](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/4.png)
...
![image-20220710095856681](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/5.png)

而二分思想就是将一个有序数组不断进行平分，直到找到为止，这样我们每次寻找的范围会不断除以2，所以查找的时间复杂度就降到了$\Omicron(\log_{2}n)$，相比一个一个比较，效率就高了不少：

![image-20220710101328777](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/6.png)
...
![image-20220723112639416](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/7.png)
...
![image-20220724150015044](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/8.png)
...
![image-20220723121423682](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/9.png)
...
![image-20220723153237528](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/10.png)
...
![image-20220723153933279](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/11.png)
...
![image-20220723154249242](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/12.png)
...
![image-20220723160222988](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/13.png)
...
![image-20220723160901921](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/14.png)
...
![image-20220723161412178](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/15.png)
...
![image-20220723161835205](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/16.png)
...
![image-20220723171648380](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/17.png)
...
![image-20220723180221112](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/18.png)
...
![image-20220723175548491](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/19.png)

我们可以先修改新插入的结点的后继结点（也就是下一个结点）指向，指向原本在这个位置的结点：

![image-20220723220552680](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/20.png)

接着我们可以将前驱结点（也就是上一个结点）的后继结点指向修改为我们新插入的结点：

![image-20220723175745472](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/21.png)

这样，我们就成功插入了一个新的结点，现在新插入的结点到达了原本的第二个位置上：

![image-20220723175842075](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/22.png)
...
![image-20220723222147977](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/23.png)

那么链表的插入我们研究完了，接着就是结点的删除了，那么我们如何实现删除操作呢？实际上也会更简单一些，我们可以直接将待删除节点的前驱结点指向修改为待删除节点的下一个：

![image-20220723222922058](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/24.png)

![image-20220723223103306](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/25.png)

这样，在逻辑上来说，待删除结点其实已经不在链表中了，所以我们只需要释放掉待删除结点占用的内存空间就行了：

![image-20220723223216420](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/26.png)
...
![image-20220723224653754](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/27.png)
...
![image-20220724123947104](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/28.png)
...
![image-20220724125739857](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/29.png)

首先我们需要考虑后继结点，当新的结点插入之后，新的结点的后继结点就是原本在此位置上的结点，所以我们可以先将待插入结点的后继指针指向此位置上的结点：

![image-20220724130010432](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/30.png)

由于是双向链表，所以我们需要将原本在此位置上的结点的前驱指针指向新的结点：

![image-20220724130219180](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/31.png)

接着我们来处理一下前驱结点，首先将前驱结点的后继指针修改为新的结点：

![image-20220724130342232](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/32.png)

 最后我们将新的结点的前驱指针指向前驱结点即可：

![image-20220724130442927](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/33.png)
...
![image-20220724132205136](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/34.png)

无论是正向遍历还是反向遍历，都可以正常完成，相比单链表的灵活度肯定是更大的，我们接着来看删除操作，其实删除操作也是差不多的方式：

![image-20220724132636580](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/35.png)

我们只需将前驱结点和后继结点的指向修改即可：

![image-20220724132801105](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/36.png)

接着直接删除对应的结点即可：

![image-20220724132906001](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/37.png)
...
![image-20220724134153904](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/38.png)
...
![image-20220724210955622](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/39.png)

也就是说，我们只能在一端进行插入和删除，当我们依次插入1、2、3、4这四个元素后，连续进行四次删除操作，删除的顺序刚好相反：4、3、2、1，我们一般将其竖着看：

![image-20220724211442421](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/40.png)
...
![image-20220724215755986](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/41.png)
...
![image-20220724221238281](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/42.png)

当然使用数组实现栈除了这种可以自己扩容的之外，也有固定大小的栈，当栈已满时，就无法再进行入栈操作了。

不过有些时候，栈的利用率可能会很低，这个时候我们可以将一个固定长度的数组共享给两个栈来使用：

![image-20220724221917968](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/43.png)
...
![image-20220724222836333](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/44.png)
...
![image-20220724223550553](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/45.png)
...
![image-20220724224644876](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/46.png)
...
![image-20220724225005605](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/47.png)
...
![image-20220725103600318](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/48.png)
...
![image-20220725110033373](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/49.png)

此时有新的元素入队了，队尾向后移动一格（+1），然后在所指向位置插入新的元素：

![image-20220725110155810](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/50.png)

之后都是同样的方式进行插入，队尾会一直向后移动：

![image-20220725110910388](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/51.png)

现在我们想要执行出队操作了，那么需要将队首向后移动一格，然后删除队首指向的元素：

![image-20220725111826355](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/52.png)
...
![image-20220725112931675](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/53.png)
...
![image-20220725113824587](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/54.png)
...
![image-20220725143455025](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/55.png)
...
![image-20220725144733780](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/56.png)

可以看到，队列是先进先出的，我们是以什么顺序放入队列中，那么出来的就是是什么顺序。

同样的，队列也可以使用链表来实现，并且使用链表的话就不需要关心容量之类的问题了，会更加灵活一些：

![image-20220725145214955](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/57.png)

注意我们需要同时保存队首和队尾两个指针，因为是单链表，所以队首需要存放指向头结点的指针，因为需要的是前驱结点，而队尾则直接是指向尾结点的指针即可，后面只需要直接在后面拼接就行。

当有新的元素入队时，只需要拼在队尾就行了，同时队尾指针也要后移一位：

![image-20220725145608827](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/58.png)

出队时，只需要移除队首指向的下一个元素即可：

![image-20220725145707707](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/59.png)
...
![image-20220725151434438](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/60.png)
...
![image-20220725152020131](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/61.png)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/62.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/63.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/64.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/65.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/66.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/算法/数据结构与算法（一）/67.jpg)
