...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/1.jpg)

### 顺序执行

顺序执行其实很好理解，就是我们依次去将这些任务完成了：

![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/2.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/3.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/4.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/5.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/6.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/7.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/8.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/9.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/10.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/11.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/13.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/14.jpg)

包括变量`i`的获取、修改、保存，都是被拆分为一个一个的操作完成的，那么这个时候就有可能出现在修改完保存之前，另一条线程也保存了，但是当前线程是毫不知情的。

![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/15.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java/juc/1/16.jpg)
