![image-20221004131436371](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/0.png)
...
![image-20220930233059528](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/1.png)
...
![image-20220930232759715](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/2.png)
...
![image-20221001002151164](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/4.png)
...
![image-20221001231509926](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/5.png)
...
![image-20221001231619391](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/6.png)
...
![image-20221002150914323](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/7.png)

一个新的迭代器就像上面这样，默认有一个指向集合中第一个元素的指针：

![image-20221002151110991](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/8.png)
...
![image-20221002152713622](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/9.png)
...
![image-20221002154018319](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/10.png)
...
![image-20221002154844743](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/11.png)
...
![image-20221002162108279](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/12.png)
...
![image-20221002163512442](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/13.png)

我们接着来看双端队列，实际上双端队列就是队列的升级版，我们一个普通的队列就是：

![image-20220725103600318](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/14.png)

普通队列中从队尾入队，队首出队，而双端队列允许在队列的两端进行入队和出队操作：

![image-20221002164302507](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/15.png)

![image-20221002164431746](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/16.png)
...
![image-20221002165618791](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/17.png)
...
![image-20221003210253093](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/18.png)
...
![image-20221003210436684](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/19.png)

只不过需要注意的是，优先级队列并不是队列中所有的元素都是按照优先级排放的，优先级队列**只能保证出队顺序是按照优先级**进行的，我们可以打印一下：

![image-20221003210545678](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/20.png)
...
![image-20221003211330129](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/21.png)
...
![image-20221003211635759](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/22.png)
...
![image-20221003212147700](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/23.png)
...
![image-20221003212233263](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/24.png)
...
![39e19f3e-04e8-4c43-8fb5-6d5288a7cdf8](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/25.jpg)
...
![image-20221003213157956](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/26.png)
...
![image-20221003214807048](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/27.png)
...
![image-20221003220156062](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/29.png)
...
![image-20221003220458539](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/30.png)
...
![image-20220820221104298](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/31.png)
...
![image-20221003224137177](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/32.png)

现在我们知道，当HashMap的一个链表长度过大时，会自动转换为红黑树：

![710c1c38-95a8-493d-8645-067b991af908](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/33.jpg)
...
![image-20221003231135805](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/34.png)
...
![image-20221003232832897](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/35.png)
...
![image-20221004001007854](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/36.png)
...
![image-20221004001409799](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/37.png)
...
![image-20221004002405375](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/38.png)
...
![image-20221004002733950](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/39.png)
...
![image-20221004125755217](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/40.png)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（六）重制版/41.png)
