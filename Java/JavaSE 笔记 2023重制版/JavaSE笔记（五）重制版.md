![image-20220924223020333](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/0.png)
...
![image-20220927135128332](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/1.png)

只不过这里需要注意一下，我们在方法中使用待确定类型的变量时，因为此时并不明确具体是什么类型，那么默认会认为这个变量是一个Object类型的变量，因为无论具体类型是什么，一定是Object类的子类：

![image-20220926235642963](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/2.png)
...
![image-20220927134825845](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/3.png)

注意，具体类型不同的泛型类变量，不能使用不同的变量进行接收：

![image-20220925170746329](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/4.png)
...
![image-20220926232135111](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/5.png)
...
![image-20220927000902574](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/6.png)

实际上就像这样：

![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/7.png)
...
![image-20220927002611032](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/8.png)

只不过下界仅适用于通配符，对于类型变量来说是不支持的。下界限定就像这样：

![4aa52791-73f4-448f-bab3-9133ea85d850.jpg](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/9.png)
...
![image-20220927131226728](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/10.png)
...
![image-20220927133232627](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/11.png)
...
![image-20220927133611288](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/12.png)
...
![image-20220927134335255](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/13.png)
...
![image-20220927181706365](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/14.png)
...
![image-20220710103307583](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/15.png)
...
![image-20220723112639416](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/16.png)
...
![image-20220724150015044](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/17.png)
...
![67813f22-3607-4351-934d-f8127e6ba15a](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/18.jpg)
...
![image-20220723153933279](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/19.png)
...
![image-20220927211134905](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/20.png)
...
![image-20220927212426959](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/21.png)
...
![image-20220723160901921](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/22.png)
...
![image-20220723171648380](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/23.png)
...
![image-20220723180221112](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/24.png)
...
![image-20220723175548491](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/25.png)

我们可以先修改新插入的结点的后继结点（也就是下一个结点）指向，指向原本在这个位置的结点：

![image-20220723220552680](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/26.png)

接着我们可以将前驱结点（也就是上一个结点）的后继结点指向修改为我们新插入的结点：

![image-20220723175745472](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/27.png)

这样，我们就成功插入了一个新的结点，现在新插入的结点到达了原本的第二个位置上：

![image-20220723175842075](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/28.png)
...
![image-20220927235051844](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/29.png)
...
![image-20220723222922058](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/30.png)

![image-20220723223103306](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/31.png)

这样，在逻辑上来说，待删除结点其实已经不在链表中了，所以我们只需要释放掉待删除结点占用的内存空间就行了：

![image-20220723223216420](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/32.png)
...
![image-20220724123947104](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/33.png)
...
![image-20220724210955622](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/34.png)

也就是说，我们只能在一端进行插入和删除，当我们依次插入1、2、3、4这四个元素后，连续进行四次删除操作，删除的顺序刚好相反：4、3、2、1，我们一般将其竖着看：

![image-20220724211442421](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/35.png)
...
![image-20220724222836333](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/36.png)
...
![image-20220724223550553](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/37.png)
...
![image-20220928101152179](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/38.png)
...
![image-20220725103600318](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/39.png)
...
![image-20220725145214955](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/40.png)

注意我们需要同时保存队首和队尾两个指针，因为是单链表，所以队首需要存放指向头结点的指针，因为需要的是前驱结点，而队尾则直接是指向尾结点的指针即可，后面只需要直接在后面拼接就行。

当有新的元素入队时，只需要拼在队尾就行了，同时队尾指针也要后移一位：

![image-20220725145608827](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/41.png)

出队时，只需要移除队首指向的下一个元素即可：

![image-20220725145707707](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/42.png)
...
![image-20220928154121872](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/43.png)
...
![树枝666](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/44.png)

在我们的程序中，想要表示出一棵树，就可以像下面这样连接：

![image-20220801210920230](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/45.png)
...
![image-20220801224008266](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/46.png)

并且二叉树任何结点的子树是有左右之分的，不能颠倒顺序，比如A结点左边的子树，称为左子树，右边的子树称为右子树。

当然，对于某些二叉树我们有特别的称呼，比如，在一棵二叉树中，所有分支结点都存在左子树和右子树，且叶子结点都在同一层：

![image-20220801231216578](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/47.png)
...
![image-20220806111610082](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/50.png)
...
![image-20220805231744693](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/51.png)
...
![image-20220930160452608](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/52.png)
...
![image-20220806171459056](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/53.png)

前序遍历是一种勇往直前的态度，走到哪就遍历到那里，先走左边再走右边，比如上面的这个图，首先会从根节点开始：

![image-20220806171431845](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/54.png)
...
![image-20220806173227580](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/55.png)
...
![image-20220806230603967](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/56.png)
...
![image-20220806231752418](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/57.png)

这样，我们就实现了二叉树的中序遍历，实际上还是很好理解的。

接着我们来看一下后序遍历，后序遍历继续将打印的时机延后，需要等待左右子树全部遍历完成，才会去进行打印。

![image-20220806233407910](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/58.png)
...
![image-20220806234428922](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/59.png)

最后我们来看层序遍历，实际上这种遍历方式是我们人脑最容易理解的，它是按照每一层在进行遍历：

![image-20220807205135936](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/60.png)
...
![image-20220807211522409](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/61.png)

接着开始不断重复上面的步骤，首先是将队首元素出队，打印A，然后将A的左右孩子依次入队：

![image-20220807211631110](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/62.png)

现在队列中有B、C两个结点，继续重复上述操作，B先出队，打印B，然后将B的左右孩子依次入队：

![image-20220807211723776](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/63.png)

现在队列中有C、D、E这三个结点，继续重复，C出队并打印，然后将F入队：

![image-20220807211800852](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/64.png)
...
![image-20220807215630429](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/65.png)
...
![image-20220814191444130](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/66.png)
...
![image-20220815113242191](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/67.png)
...
![image-20220815113705827](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/68.png)
...
![image-20220815210652973](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/69.png)

通过计算平衡因子，我们就可以快速得到是否出现失衡的情况。比如下面的这棵二叉树，正在执行插入操作：

![image-20220815115219250](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/70.png)

可以看到，当插入之后，不再满足平衡二叉树的定义时，就出现了失衡的情况，而对于这种失衡情况，为了继续保持平衡状态，我们就需要进行处理了。我们可能会遇到以下几种情况导致失衡：

![image-20220815115836604](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/71.png)
...
1. **LL型调整**（右旋）
   ...
   ![image-20220815211641144](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/72.png)

   首先我们来看这种情况，这是典型的LL型失衡，为了能够保证二叉树的平衡，我们需要将其进行**旋转**来维持平衡，去纠正最小不平衡子树即可。那么怎么进行旋转呢？对于LL型失衡，我们只需要进行右旋操作，首先我们先找到最小不平衡子树，注意是最小的那一个：

   ![image-20220815212552176](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/73.png)

   可以看到根结点的平衡因子是2，是目前最小的出现不平衡的点，所以说从根结点开始向左的三个结点需要进行右旋操作，右旋需要将这三个结点中间的结点作为新的根结点，而其他两个结点现在变成左右子树：

   ![image-20220815213222964](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/74.png)
...
2. **RR型调整**（左旋）
   ...
   ![image-20220815214026710](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/75.png)

   操作和上面是一样的，只不过现在反过来了而已：

   ![image-20220815214408651](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/76.png)
...
3. **RL型调整**（先右旋，再左旋）
   ...
   ![image-20220815214859501](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/77.png)

   可以看到现在的形状是一个回旋镖形状的，先右后左的一个状态，也就是RL型，针对于这种情况，我们需要先进行右旋操作，注意这里的右旋操作针对的是后两个结点：

   ![image-20220815215929303](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/78.png)
...
4. **LR型调整**（先左旋，再右旋）
   ...
   ![image-20220815220609357](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/79.png)

   形状是先向左再向右，这就是典型的LR型了，我们同样需要对其进行两次旋转：

   ![image-20220815221349044](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/80.png)
...
![image-20220815222810537](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/81.png)
...
![image-20220816104917851](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/82.png)

首先这棵红黑树只有一个根结点，因为根结点必须是黑色，所以说直接变成黑色。现在我们要插入一个新的结点了，所有新插入的结点，默认情况下都是红色：

![image-20220816105119178](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/83.png)

所以新来的结点7根据规则就直接放到11的左边就行了，然后注意7的左右两边都是NULL，那么默认都是黑色，这里就不画出来了。同样的，我们往右边也来一个：

![image-20220816105553070](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/84.png)

现在我们继续插入一个结点：

![image-20220816105656320](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/85.png)
...
![image-20220816113259643](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/86.png)
...
![image-20220816113339344](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/87.png)

接着我们继续插入结点：

![image-20220816113939172](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/88.png)

此时又来了一个插在4左边的结点，同样是连续红色，我们需要进行变色才可以讲解问题，但是我们发现，如果变色的话，那么从11开始到所有NIL结点经历的黑色结点数量就不对了：

![image-20220816114245996](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/89.png)

所以说对于这种**父结点为红色，父结点的兄弟结点为黑色**（NIL视为黑色）的情况，变色无法解决问题了，那么我们只能考虑旋转了，旋转规则和我们之前讲解的平衡二叉树是一样的，这实际上是一种LL型失衡：

![image-20220816115015892](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/90.png)

同样的，如果遇到了LR型失衡，跟前面一样，先左旋在右旋，然后进行变色即可：

![image-20220816115924938](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/91.png)
...
![image-20220818214145347](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/92.png)
...
![image-20220818214908458](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/93.png)
...
![image-20220818220944783](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/94.png)
...
![image-20220819170355221](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/95.png)

比如现在我们需要插入一个新的元素（关键字为17）到哈希表中：

![image-20220819171430332](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/96.png)

插入的位置为计算出来的哈希值，比如上面是8，那么就在下标位置8插入元素，同样的，我们继续插入27：

![image-20220819210336314](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/97.png)

这样，我们就可以将多种多样的数据保存到哈希表中了，注意保存的数据是无序的，因为我们也不清楚计算完哈希值最后会放到哪个位置。那么如果现在我们想要从哈希表中查找数据呢？比如我们现在需要查找哈希表中是否有14这个元素：

![image-20220819211656628](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/98.png)
...
![image-20220819215004653](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/99.png)
...
![image-20220820220237535](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/100.png)

当表中元素变多时，差不多就变成了这样，我们一般将其横过来看：

![image-20220820221104298](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/101.png)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/102.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JavaSE笔记（五）重制版/103.jpg)
