...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/0.jpg)
...
![image-20220129195318339](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/1.jpg)

点击`应用`即可，接着打开运行配置，添加一个新的自定义配置：

![image-20220129195459914](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/2.jpg)
...
![image-20220129195801789](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/3.jpg)
...
![image-20220129200244279](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/4.jpg)

点击右上角调试按钮，可以成功进行调试：

![image-20220129200314691](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/5.jpg)
...
![image-20220129211342240](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/6.jpg)

还是以我们之前编写的测试类进行，首先来到调用之前，我们看到主方法执行之前，控制台没有输出任何内容，接着我们执行此函数，再来观察控制台的变化：

![image-20220129211450939](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/7.jpg)

可以看到，主方法执行完成之后，控制台也成功输出了Hello World！

继续下一步，整个Java程序执行完成，得到退出状态码`0`：

![image-20220129211540210](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/8.jpg)

成功验证，最后总结一下整个执行过程：

![image-20220129213143973](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/9.jpg)
...
![img](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/10.jpg)
...
![image-20220129222858105](https://tencent.cos.mobaijun.com/img/gitbook/java//JVM笔记（一）/11.jpg)
